...
public final class b implements cp.a {
    ...
    private static final String f105878b = "b";

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    private final SecretKey f105879a;

    b(String str, KeyStore keyStore) throws InvalidKeyException {
        SecretKey secretKey = (SecretKey) keyStore.getKey(str, null);
        this.f105879a = secretKey;
        if (secretKey != null) {
            return;
        }
    ...
    private byte[] c(byte[] bArr, byte[] bArr2) throws NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        cipher.init(2, this.f105879a, gCMParameterSpec);
    ...
    public byte[] a(byte[] bArr, byte[] bArr2) {
        try {
            ...
            Log.w(f105878b, "encountered a potentially transient KeyStore error, will wait and retry", e11);
            e();
    ...
    public byte[] b(byte[] bArr, byte[] bArr2) throws GeneralSecurityException {
        ...
        try {
            ...
            Log.w(f105878b, "encountered a potentially transient KeyStore error, will wait and retry", e12);
            e();
