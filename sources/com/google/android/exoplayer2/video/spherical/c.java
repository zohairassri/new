...
final class c {
    ...
    public static final class a {
        ...
        public a(b... bVarArr) {
            this.f21804a = bVarArr;
        }

        public b a(int i11) {
            return this.f21804a[i11];
        }

        public int b() {
            return this.f21804a.length;
        }
    }
    ...
    public static final class b {
        ...
        public b(int i11, float[] fArr, float[] fArr2, int i12) {
            this.f21805a = i11;
            ml.a.a(((long) fArr.length) * 2 == ((long) fArr2.length) * 3);
            this.f21807c = fArr;
            this.f21808d = fArr2;
            this.f21806b = i12;
        }
    ...
    public static c a(float f11, int i11, int i12, float f12, float f13, int i13) {
        ...
        ml.a.a(i15 >= 1);
        ml.a.a(i12 >= 1);
        ml.a.a(f12 > 0.0f && f12 <= 180.0f);
        ml.a.a(f13 > 0.0f && f13 <= 360.0f);
