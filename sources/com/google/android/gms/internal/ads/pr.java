...
public abstract class pr implements IInterface {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    private final IBinder f33194a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private final String f33195b;

    protected pr(IBinder iBinder, String str) {
        this.f33194a = iBinder;
        this.f33195b = str;
    }
    ...
    protected final void I0(int i11, Parcel parcel) {
        ...
        try {
            this.f33194a.transact(i11, parcel, parcelObtain, 0);
    ...
    protected final Parcel R() {
        Parcel parcelObtain = Parcel.obtain();
        parcelObtain.writeInterfaceToken(this.f33195b);
        return parcelObtain;
    }
    ...
    protected final void k1(int i11, Parcel parcel) {
        try {
            this.f33194a.transact(i11, parcel, null, 1);
        } finally {
            parcel.recycle();
        }
    }
