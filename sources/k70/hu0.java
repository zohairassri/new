...
public final class hu0 implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f108356a.containsValue(value);
    }

    public Set d() {
        return this.f108356a.entrySet();
    }
    ...
    public Set f() {
        return this.f108356a.keySet();
    }

    public int g() {
        return this.f108356a.size();
    }
    ...
    public Collection h() {
        return this.f108356a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f108356a.isEmpty();
    }
