...
public final class u5 implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f109464a.containsValue(value);
    }

    public Set d() {
        return this.f109464a.entrySet();
    }
    ...
    public Set f() {
        return this.f109464a.keySet();
    }

    public int g() {
        return this.f109464a.size();
    }
    ...
    public Collection h() {
        return this.f109464a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f109464a.isEmpty();
    }
