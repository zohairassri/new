...
public final class du0 implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f108037a.containsValue(value);
    }

    public Set d() {
        return this.f108037a.entrySet();
    }
    ...
    public Set f() {
        return this.f108037a.keySet();
    }

    public int g() {
        return this.f108037a.size();
    }
    ...
    public Collection h() {
        return this.f108037a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f108037a.isEmpty();
    }
