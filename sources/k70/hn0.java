...
public final class hn0 implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f108347a.containsValue(value);
    }

    public Set d() {
        return this.f108347a.entrySet();
    }
    ...
    public Collection h() {
        return this.f108347a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f108347a.isEmpty();
    }
