...
public final class md0 implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f108832a.containsValue(value);
    }

    public Set d() {
        return this.f108832a.entrySet();
    }
    ...
    public Set f() {
        return this.f108832a.keySet();
    }

    public int g() {
        return this.f108832a.size();
    }
    ...
    public Collection h() {
        return this.f108832a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f108832a.isEmpty();
    }
