...
public final class e50 implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f108062a.containsValue(value);
    }

    public Set d() {
        return this.f108062a.entrySet();
    }
    ...
    public Collection h() {
        return this.f108062a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f108062a.isEmpty();
    }
