...
public final class i10 implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f108373a.containsValue(value);
    }

    public Set d() {
        return this.f108373a.entrySet();
    }
    ...
    public Set f() {
        return this.f108373a.keySet();
    }

    public int g() {
        return this.f108373a.size();
    }
    ...
    public Collection h() {
        return this.f108373a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f108373a.isEmpty();
    }
