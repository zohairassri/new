...
public final class cq implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f107930a.containsValue(value);
    }

    public Set d() {
        return this.f107930a.entrySet();
    }
    ...
    public Collection h() {
        return this.f107930a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f107930a.isEmpty();
    }
