...
public final class kk implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f108688a.containsValue(value);
    }

    public Set d() {
        return this.f108688a.entrySet();
    }
    ...
    public Collection h() {
        return this.f108688a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f108688a.isEmpty();
    }
