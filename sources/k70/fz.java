...
public final class fz implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f108189a.containsValue(value);
    }

    public Set d() {
        return this.f108189a.entrySet();
    }
    ...
    public Set f() {
        return this.f108189a.keySet();
    }

    public int g() {
        return this.f108189a.size();
    }
    ...
    public Collection h() {
        return this.f108189a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f108189a.isEmpty();
    }
