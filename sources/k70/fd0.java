...
public final class fd0 implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f108158a.containsValue(value);
    }

    public Set d() {
        return this.f108158a.entrySet();
    }
    ...
    public Set f() {
        return this.f108158a.keySet();
    }

    public int g() {
        return this.f108158a.size();
    }
    ...
    public Collection h() {
        return this.f108158a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f108158a.isEmpty();
    }
