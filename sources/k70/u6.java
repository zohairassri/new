...
public final class u6 implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f109465a.containsValue(value);
    }

    public Set d() {
        return this.f109465a.entrySet();
    }
    ...
    public Set f() {
        return this.f109465a.keySet();
    }

    public int g() {
        return this.f109465a.size();
    }
    ...
    public Collection h() {
        return this.f109465a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f109465a.isEmpty();
    }
