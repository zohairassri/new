...
public final class ke0 implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f108680a.containsValue(value);
    }

    public Set d() {
        return this.f108680a.entrySet();
    }
    ...
    public Set f() {
        return this.f108680a.keySet();
    }

    public int g() {
        return this.f108680a.size();
    }
