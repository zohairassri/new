...
public final class u8 implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f109467a.containsValue(value);
    }

    public Set d() {
        return this.f109467a.entrySet();
    }
    ...
    public Set f() {
        return this.f109467a.keySet();
    }

    public int g() {
        return this.f109467a.size();
    }
    ...
    public Collection h() {
        return this.f109467a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f109467a.isEmpty();
    }
