...
public final class tf implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f109408a.containsValue(value);
    }

    public Set d() {
        return this.f109408a.entrySet();
    }
    ...
    public Set f() {
        return this.f109408a.keySet();
    }

    public int g() {
        return this.f109408a.size();
    }
    ...
    public Collection h() {
        return this.f109408a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f109408a.isEmpty();
    }
