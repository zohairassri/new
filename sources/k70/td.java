...
public final class td implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f109405a.containsValue(value);
    }

    public Set d() {
        return this.f109405a.entrySet();
    }
    ...
    public Collection h() {
        return this.f109405a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f109405a.isEmpty();
    }
