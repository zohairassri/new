...
public final class mw implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f108871a.containsValue(value);
    }

    public Set d() {
        return this.f108871a.entrySet();
    }
    ...
    public Set f() {
        return this.f108871a.keySet();
    }

    public int g() {
        return this.f108871a.size();
    }
    ...
    public Collection h() {
        return this.f108871a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f108871a.isEmpty();
    }
