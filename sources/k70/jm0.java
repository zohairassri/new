...
public final class jm0 implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f108564a.containsValue(value);
    }

    public Set d() {
        return this.f108564a.entrySet();
    }
    ...
    public Set f() {
        return this.f108564a.keySet();
    }

    public int g() {
        return this.f108564a.size();
    }
    ...
    public Collection h() {
        return this.f108564a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f108564a.isEmpty();
    }
