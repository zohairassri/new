...
public final class jz0 implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f108589a.containsValue(value);
    }

    public Set d() {
        return this.f108589a.entrySet();
    }
    ...
    public Collection h() {
        return this.f108589a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f108589a.isEmpty();
    }
