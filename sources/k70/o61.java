...
public final class o61 implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f108996a.containsValue(value);
    }

    public Set d() {
        return this.f108996a.entrySet();
    }
    ...
    public Set f() {
        return this.f108996a.keySet();
    }

    public int g() {
        return this.f108996a.size();
    }
    ...
    public Collection h() {
        return this.f108996a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f108996a.isEmpty();
    }
