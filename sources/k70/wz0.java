...
public final class wz0 implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f109737a.containsValue(value);
    }

    public Set d() {
        return this.f109737a.entrySet();
    }
    ...
    public Set f() {
        return this.f109737a.keySet();
    }

    public int g() {
        return this.f109737a.size();
    }
