...
public final class hs0 implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f108353a.containsValue(value);
    }

    public Set d() {
        return this.f108353a.entrySet();
    }
    ...
    public Set f() {
        return this.f108353a.keySet();
    }

    public int g() {
        return this.f108353a.size();
    }
