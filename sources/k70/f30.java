...
public final class f30 implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f108128a.containsValue(value);
    }

    public Set d() {
        return this.f108128a.entrySet();
    }
    ...
    public Set f() {
        return this.f108128a.keySet();
    }

    public int g() {
        return this.f108128a.size();
    }
    ...
    public Collection h() {
        return this.f108128a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f108128a.isEmpty();
    }
