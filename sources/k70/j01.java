...
public final class j01 implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f108457a.containsValue(value);
    }

    public Set d() {
        return this.f108457a.entrySet();
    }
    ...
    public Set f() {
        return this.f108457a.keySet();
    }

    public int g() {
        return this.f108457a.size();
    }
    ...
    public Collection h() {
        return this.f108457a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f108457a.isEmpty();
    }
