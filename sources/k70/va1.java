...
public final class va1 implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f109564a.containsValue(value);
    }

    public Set d() {
        return this.f109564a.entrySet();
    }
    ...
    public Collection h() {
        return this.f109564a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f109564a.isEmpty();
    }
