...
public final class d21 implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f107961a.containsValue(value);
    }

    public Set d() {
        return this.f107961a.entrySet();
    }
    ...
    public Set f() {
        return this.f107961a.keySet();
    }

    public int g() {
        return this.f107961a.size();
    }
    ...
    public Collection h() {
        return this.f107961a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f107961a.isEmpty();
    }
