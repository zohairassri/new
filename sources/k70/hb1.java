...
public final class hb1 implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f108313a.containsValue(value);
    }

    public Set d() {
        return this.f108313a.entrySet();
    }
    ...
    public Set f() {
        return this.f108313a.keySet();
    }

    public int g() {
        return this.f108313a.size();
    }
    ...
    public Collection h() {
        return this.f108313a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f108313a.isEmpty();
    }
