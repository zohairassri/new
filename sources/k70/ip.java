...
public final class ip implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f108437a.containsValue(value);
    }

    public Set d() {
        return this.f108437a.entrySet();
    }
    ...
    public Set f() {
        return this.f108437a.keySet();
    }

    public int g() {
        return this.f108437a.size();
    }
    ...
    public Collection h() {
        return this.f108437a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f108437a.isEmpty();
    }
