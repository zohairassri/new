...
public final class et implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f108104a.containsValue(value);
    }

    public Set d() {
        return this.f108104a.entrySet();
    }
    ...
    public Set f() {
        return this.f108104a.keySet();
    }

    public int g() {
        return this.f108104a.size();
    }
    ...
    public Collection h() {
        return this.f108104a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f108104a.isEmpty();
    }
