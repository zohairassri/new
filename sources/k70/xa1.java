...
public final class xa1 implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f109775a.containsValue(value);
    }

    public Set d() {
        return this.f109775a.entrySet();
    }
    ...
    public Set f() {
        return this.f109775a.keySet();
    }

    public int g() {
        return this.f109775a.size();
    }
