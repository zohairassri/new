...
public final class tc0 implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f109404a.containsValue(value);
    }

    public Set d() {
        return this.f109404a.entrySet();
    }
    ...
    public Collection h() {
        return this.f109404a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f109404a.isEmpty();
    }
