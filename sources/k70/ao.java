...
public final class ao implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f107755a.containsValue(value);
    }

    public Set d() {
        return this.f107755a.entrySet();
    }
    ...
    public Set f() {
        return this.f107755a.keySet();
    }

    public int g() {
        return this.f107755a.size();
    }
    ...
    public Collection h() {
        return this.f107755a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f107755a.isEmpty();
    }
