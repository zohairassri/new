...
public final class nh0 implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f108936a.containsValue(value);
    }

    public Set d() {
        return this.f108936a.entrySet();
    }
    ...
    public Set f() {
        return this.f108936a.keySet();
    }

    public int g() {
        return this.f108936a.size();
    }
    ...
    public Collection h() {
        return this.f108936a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f108936a.isEmpty();
    }
