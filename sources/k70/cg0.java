...
public final class cg0 implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f107905a.containsValue(value);
    }

    public Set d() {
        return this.f107905a.entrySet();
    }
    ...
    public Set f() {
        return this.f107905a.keySet();
    }

    public int g() {
        return this.f107905a.size();
    }
    ...
    public Collection h() {
        return this.f107905a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f107905a.isEmpty();
    }
