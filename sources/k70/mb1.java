...
public final class mb1 implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f108826a.containsValue(value);
    }

    public Set d() {
        return this.f108826a.entrySet();
    }
    ...
    public Set f() {
        return this.f108826a.keySet();
    }

    public int g() {
        return this.f108826a.size();
    }
    ...
    public Collection h() {
        return this.f108826a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f108826a.isEmpty();
    }
