...
public final class jt implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f108574a.containsValue(value);
    }

    public Set d() {
        return this.f108574a.entrySet();
    }
    ...
    public Set f() {
        return this.f108574a.keySet();
    }

    public int g() {
        return this.f108574a.size();
    }
    ...
    public Collection h() {
        return this.f108574a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f108574a.isEmpty();
    }
