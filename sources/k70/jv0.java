...
public final class jv0 implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f108579a.containsValue(value);
    }

    public Set d() {
        return this.f108579a.entrySet();
    }
    ...
    public Set f() {
        return this.f108579a.keySet();
    }

    public int g() {
        return this.f108579a.size();
    }
    ...
    public Collection h() {
        return this.f108579a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f108579a.isEmpty();
    }
