...
public final class os implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f109035a.containsValue(value);
    }

    public Set d() {
        return this.f109035a.entrySet();
    }
    ...
    public Set f() {
        return this.f109035a.keySet();
    }

    public int g() {
        return this.f109035a.size();
    }
    ...
    public Collection h() {
        return this.f109035a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f109035a.isEmpty();
    }
