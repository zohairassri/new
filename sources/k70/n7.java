...
public final class n7 implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f108905a.containsValue(value);
    }

    public Set d() {
        return this.f108905a.entrySet();
    }
    ...
    public Set f() {
        return this.f108905a.keySet();
    }

    public int g() {
        return this.f108905a.size();
    }
    ...
    public Collection h() {
        return this.f108905a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f108905a.isEmpty();
    }
