...
public final class nz0 implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f108964a.containsValue(value);
    }

    public Set d() {
        return this.f108964a.entrySet();
    }
    ...
    public Set f() {
        return this.f108964a.keySet();
    }

    public int g() {
        return this.f108964a.size();
    }
    ...
    public Collection h() {
        return this.f108964a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f108964a.isEmpty();
    }
