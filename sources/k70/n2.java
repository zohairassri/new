...
public final class n2 implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f108887a.containsValue(value);
    }

    public Set d() {
        return this.f108887a.entrySet();
    }
    ...
    public Set f() {
        return this.f108887a.keySet();
    }

    public int g() {
        return this.f108887a.size();
    }
    ...
    public Collection h() {
        return this.f108887a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f108887a.isEmpty();
    }
