...
public final class t20 implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f109379a.containsValue(value);
    }

    public Set d() {
        return this.f109379a.entrySet();
    }
    ...
    public Collection h() {
        return this.f109379a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f109379a.isEmpty();
    }
