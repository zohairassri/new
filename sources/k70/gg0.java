...
public final class gg0 implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f108234a.containsValue(value);
    }

    public Set d() {
        return this.f108234a.entrySet();
    }
    ...
    public Set f() {
        return this.f108234a.keySet();
    }

    public int g() {
        return this.f108234a.size();
    }
    ...
    public Collection h() {
        return this.f108234a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f108234a.isEmpty();
    }
