...
public final class bg implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f107813a.containsValue(value);
    }

    public Set d() {
        return this.f107813a.entrySet();
    }
    ...
    public Set f() {
        return this.f107813a.keySet();
    }

    public int g() {
        return this.f107813a.size();
    }
    ...
    public Collection h() {
        return this.f107813a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f107813a.isEmpty();
    }
