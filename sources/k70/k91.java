...
public final class k91 implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f108668a.containsValue(value);
    }

    public Set d() {
        return this.f108668a.entrySet();
    }
    ...
    public Set f() {
        return this.f108668a.keySet();
    }

    public int g() {
        return this.f108668a.size();
    }
    ...
    public Collection h() {
        return this.f108668a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f108668a.isEmpty();
    }
