...
public final class kj implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f108687a.containsValue(value);
    }

    public Set d() {
        return this.f108687a.entrySet();
    }
    ...
    public Set f() {
        return this.f108687a.keySet();
    }

    public int g() {
        return this.f108687a.size();
    }
    ...
    public Collection h() {
        return this.f108687a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f108687a.isEmpty();
    }
