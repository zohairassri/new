...
public final class bb implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f107806a.containsValue(value);
    }

    public Set d() {
        return this.f107806a.entrySet();
    }
    ...
    public Set f() {
        return this.f107806a.keySet();
    }

    public int g() {
        return this.f107806a.size();
    }
    ...
    public Collection h() {
        return this.f107806a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f107806a.isEmpty();
    }
