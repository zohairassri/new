...
public final class to implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f109425a.containsValue(value);
    }

    public Set d() {
        return this.f109425a.entrySet();
    }
    ...
    public Set f() {
        return this.f109425a.keySet();
    }

    public int g() {
        return this.f109425a.size();
    }
    ...
    public Collection h() {
        return this.f109425a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f109425a.isEmpty();
    }
