...
public final class e11 implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f108054a.containsValue(value);
    }

    public Set d() {
        return this.f108054a.entrySet();
    }
    ...
    public Set f() {
        return this.f108054a.keySet();
    }

    public int g() {
        return this.f108054a.size();
    }
    ...
    public Collection h() {
        return this.f108054a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f108054a.isEmpty();
    }
