...
public final class ds implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f108031a.containsValue(value);
    }

    public Set d() {
        return this.f108031a.entrySet();
    }
    ...
    public Set f() {
        return this.f108031a.keySet();
    }

    public int g() {
        return this.f108031a.size();
    }
    ...
    public Collection h() {
        return this.f108031a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f108031a.isEmpty();
    }
