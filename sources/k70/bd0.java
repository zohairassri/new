...
public final class bd0 implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f107809a.containsValue(value);
    }

    public Set d() {
        return this.f107809a.entrySet();
    }
    ...
    public Set f() {
        return this.f107809a.keySet();
    }

    public int g() {
        return this.f107809a.size();
    }
    ...
    public Collection h() {
        return this.f107809a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f107809a.isEmpty();
    }
