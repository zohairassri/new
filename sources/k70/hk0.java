...
public final class hk0 implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f108341a.containsValue(value);
    }

    public Set d() {
        return this.f108341a.entrySet();
    }
    ...
    public Set f() {
        return this.f108341a.keySet();
    }

    public int g() {
        return this.f108341a.size();
    }
    ...
    public Collection h() {
        return this.f108341a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f108341a.isEmpty();
    }
