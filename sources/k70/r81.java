...
public final class r81 implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f109241a.containsValue(value);
    }

    public Set d() {
        return this.f109241a.entrySet();
    }
    ...
    public Set f() {
        return this.f109241a.keySet();
    }

    public int g() {
        return this.f109241a.size();
    }
