...
public final class lm implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f108774a.containsValue(value);
    }

    public Set d() {
        return this.f108774a.entrySet();
    }
    ...
    public Set f() {
        return this.f108774a.keySet();
    }

    public int g() {
        return this.f108774a.size();
    }
    ...
    public Collection h() {
        return this.f108774a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f108774a.isEmpty();
    }
