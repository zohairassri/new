...
public final class kg implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f108682a.containsValue(value);
    }

    public Set d() {
        return this.f108682a.entrySet();
    }
    ...
    public Set f() {
        return this.f108682a.keySet();
    }

    public int g() {
        return this.f108682a.size();
    }
    ...
    public Collection h() {
        return this.f108682a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f108682a.isEmpty();
    }
