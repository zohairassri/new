...
public final class eq0 implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f108101a.containsValue(value);
    }

    public Set d() {
        return this.f108101a.entrySet();
    }
    ...
    public Set f() {
        return this.f108101a.keySet();
    }

    public int g() {
        return this.f108101a.size();
    }
    ...
    public Collection h() {
        return this.f108101a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f108101a.isEmpty();
    }
