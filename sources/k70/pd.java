...
public final class pd implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f109082a.containsValue(value);
    }

    public Set d() {
        return this.f109082a.entrySet();
    }
    ...
    public Set f() {
        return this.f109082a.keySet();
    }

    public int g() {
        return this.f109082a.size();
    }
    ...
    public Collection h() {
        return this.f109082a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f109082a.isEmpty();
    }
