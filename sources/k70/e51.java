...
public final class e51 implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f108063a.containsValue(value);
    }

    public Set d() {
        return this.f108063a.entrySet();
    }
    ...
    public Collection h() {
        return this.f108063a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f108063a.isEmpty();
    }
