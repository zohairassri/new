...
public final class m81 implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f108820a.containsValue(value);
    }

    public Set d() {
        return this.f108820a.entrySet();
    }
    ...
    public Set f() {
        return this.f108820a.keySet();
    }

    public int g() {
        return this.f108820a.size();
    }
    ...
    public Collection h() {
        return this.f108820a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f108820a.isEmpty();
    }
