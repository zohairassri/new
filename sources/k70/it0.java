...
public final class it0 implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f108443a.containsValue(value);
    }

    public Set d() {
        return this.f108443a.entrySet();
    }
    ...
    public Set f() {
        return this.f108443a.keySet();
    }

    public int g() {
        return this.f108443a.size();
    }
    ...
    public Collection h() {
        return this.f108443a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f108443a.isEmpty();
    }
