...
public final class na implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f108915a.containsValue(value);
    }

    public Set d() {
        return this.f108915a.entrySet();
    }
    ...
    public Set f() {
        return this.f108915a.keySet();
    }

    public int g() {
        return this.f108915a.size();
    }
    ...
    public Collection h() {
        return this.f108915a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f108915a.isEmpty();
    }
