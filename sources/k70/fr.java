...
public final class fr implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f108172a.containsValue(value);
    }

    public Set d() {
        return this.f108172a.entrySet();
    }
    ...
    public Set f() {
        return this.f108172a.keySet();
    }

    public int g() {
        return this.f108172a.size();
    }
    ...
    public Collection h() {
        return this.f108172a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f108172a.isEmpty();
    }
