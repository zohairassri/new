...
public final class ll0 implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f108773a.containsValue(value);
    }

    public Set d() {
        return this.f108773a.entrySet();
    }
    ...
    public Set f() {
        return this.f108773a.keySet();
    }

    public int g() {
        return this.f108773a.size();
    }
    ...
    public Collection h() {
        return this.f108773a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f108773a.isEmpty();
    }
