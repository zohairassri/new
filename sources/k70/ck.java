...
public final class ck implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f107912a.containsValue(value);
    }

    public Set d() {
        return this.f107912a.entrySet();
    }
    ...
    public Collection h() {
        return this.f107912a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f107912a.isEmpty();
    }
