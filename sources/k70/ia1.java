...
public final class ia1 implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f108397a.containsValue(value);
    }

    public Set d() {
        return this.f108397a.entrySet();
    }
    ...
    public Set f() {
        return this.f108397a.keySet();
    }

    public int g() {
        return this.f108397a.size();
    }
    ...
    public Collection h() {
        return this.f108397a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f108397a.isEmpty();
    }
