...
public final class fa implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f108148a.containsValue(value);
    }

    public Set d() {
        return this.f108148a.entrySet();
    }
    ...
    public Set f() {
        return this.f108148a.keySet();
    }

    public int g() {
        return this.f108148a.size();
    }
    ...
    public Collection h() {
        return this.f108148a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f108148a.isEmpty();
    }
