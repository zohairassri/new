...
public final class gg implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f108233a.containsValue(value);
    }

    public Set d() {
        return this.f108233a.entrySet();
    }
    ...
    public Set f() {
        return this.f108233a.keySet();
    }

    public int g() {
        return this.f108233a.size();
    }
    ...
    public Collection h() {
        return this.f108233a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f108233a.isEmpty();
    }
