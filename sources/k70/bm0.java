...
public final class bm0 implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f107819a.containsValue(value);
    }

    public Set d() {
        return this.f107819a.entrySet();
    }
    ...
    public Collection h() {
        return this.f107819a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f107819a.isEmpty();
    }
