...
public final class fd implements Map<String, Object>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        return this.f108157a.containsValue(value);
    }

    public Set d() {
        return this.f108157a.entrySet();
    }
    ...
    public Set f() {
        return this.f108157a.keySet();
    }

    public int g() {
        return this.f108157a.size();
    }
    ...
    public Collection h() {
        return this.f108157a.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f108157a.isEmpty();
    }
