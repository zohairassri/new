...
public abstract class u {
    ...
    private static final ArrayList f116831a = new ArrayList();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static final Pattern f116832b = Pattern.compile("^mp4a\\.([a-zA-Z0-9]{2})(?:\\.([0-9]{1,2}))?$");

    /* JADX INFO: compiled from: r8-map-id-9e7ee9a42fe7cc4cda6cf7a37f69f1db09989c88ba665561dcfb218d3d1b2345 */
    static final class a {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        public final int f116833a;
    ...
    public static boolean a(String str, String str2) {
        ...
        switch (str) {
            case "audio/mp4a-latm":
                if (str2 != null && (aVarG = g(str2)) != null && (iA = aVarG.a()) != 0 && iA != 16) {
                }
                break;
        }
        return false;
    ...
    public static int d(String str, String str2) {
        ...
        switch (str) {
            ...
            case "audio/vnd.dts":
                return 7;
            case "audio/mp4a-latm":
                if (str2 == null || (aVarG = g(str2)) == null) {
                    return 0;
                }
                return aVarG.a();
            case "audio/ac3":
    ...
    public static String e(String str) {
        ...
        if (strE.startsWith("mp4a.") && (aVarG = g(strE)) != null) {
            strF = f(aVarG.f116833a);
        }
    ...
    static a g(String str) {
        Matcher matcher = f116832b.matcher(str);
        if (!matcher.matches()) {
            return null;
        }
        String str2 = (String) ml.a.e(matcher.group(1));
